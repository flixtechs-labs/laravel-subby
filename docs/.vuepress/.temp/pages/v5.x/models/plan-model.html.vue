...
<nav class="table-of-contents"><ul><li><router-link to="#create-a-plan">Create a Plan</router-link></li><li><router-link to="#get-plan-details">Get Plan details</router-link></li><li><router-link to="#trial-modes">Trial modes</router-link><ul><li><router-link to="#if-plan-has-trial">If plan has trial</router-link></li><li><router-link to="#if-plan-does-not-have-trial">If plan does not have trial</router-link></li><li><router-link to="#trial-period-time-related-functions">Trial period time related functions <Badge text="new in v5.0" type="tip"/></router-link></li></ul></li><li><router-link to="#tiers">Tiers</router-link><ul><li><router-link to="#example">Example</router-link></li></ul></li><li><router-link to="#grace">Grace <Badge text="new in v5.0" type="tip"/></router-link><ul><li><router-link to="#grace-related-functions">Grace related functions</router-link></li></ul></li><li><router-link to="#subscription-period-time-related-functions">Subscription period time related functions <Badge text="new in v5.0" type="tip"/></router-link></li></ul></nav>
<p>This is the main model of the package, there is nothing without plans. After creating a plan, you
can <RouteLink to="/v5.x/models/plan-subscription-model.html#create-a-subscription">attach it to a subscription</RouteLink>.</p>
...
<p>Also read:</p>
<ul>
<li><RouteLink to="/v5.x/models/plan-feature-model.html#get-plan-feature-value">Get Plan Feature value</RouteLink></li>
</ul>
...
<h3 id="trial-period-time-related-functions" tabindex="-1"><a class="header-anchor" href="#trial-period-time-related-functions"><span>Trial period time related functions <Badge text="new in v5.0" type="tip"/></span></a></h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="grace" tabindex="-1"><a class="header-anchor" href="#grace"><span>Grace <Badge text="new in v5.0" type="tip"/></span></a></h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="subscription-period-time-related-functions" tabindex="-1"><a class="header-anchor" href="#subscription-period-time-related-functions"><span>Subscription period time related functions <Badge text="new in v5.0" type="tip"/></span></a></h2>
