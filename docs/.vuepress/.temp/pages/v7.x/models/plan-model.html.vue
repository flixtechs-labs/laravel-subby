...
can <RouteLink to="/v7.x/models/plan-subscription-model.html#create-a-subscription">attach it to a subscription</RouteLink>.</p>
...
<p>Also read:</p>
<ul>
<li><RouteLink to="/v7.x/models/plan-feature-model.html#get-plan-feature-value">Get Plan Feature value</RouteLink></li>
</ul>
